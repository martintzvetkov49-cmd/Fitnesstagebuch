...
export default function App() {
  ...
  const startWorkout = (planId) => { setActivePlanId(planId); setView('workout'); };
  const goHome = () => { setView('home'); setActivePlanId(null); };
    ...
    <div style={{ maxWidth: 520, margin: '0 auto', padding: '16px 16px 96px', minHeight: '100dvh' }}>
      ...
      {view === 'home' && tab === 'home' && (
        <HomeView
          data={data}
          onCreate={createPlan}
          onEdit={(id) => { setActivePlanId(id); setView('editPlan'); }}
          onDelete={deletePlan}
